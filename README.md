...
| `tools/` | Outils du PC. `tools/upload/` envoie une image binaire à la carte. |
| `docs/` | Documentation. |
...
- [docs/upload.md](docs/upload.md) couvre le format des images, le protocole d'envoi et l'outil `tools/upload`.
